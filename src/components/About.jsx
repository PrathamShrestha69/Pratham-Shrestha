        ...
        <div className="flex flex-col justify-around">
          <div className="sm:px-16 px-2">
            ...
            <p className="mt-3 mb-6 text-[17px] max-w-3xl leading-[30px]">
              👨‍💻 Hi, I'm Pratham Shrestha, a student of Computer Science with a
              passion for crafting robust frontend systems.As a seasoned{" "}
              <a
              ...
              , where I delveop into the intricacies of software development and
              technology trends.
            </p>
