export const services = [
  {
    ...
    icon: "https://e7.pngegg.com/pngimages/18/497/png-clipart-black-and-blue-atom-icon-screenshot-react-javascript-responsive-web-design-github-angularjs-github-logo-electric-blue.png",
  },
];

export const name = "Pratham";
...
export const EMAIL_JS_SERVICE_ID = "service_3gx14u4";
export const EMAIL_JS_TEMPLATE_ID = "template_dl0v9t3";
export const EMAIL_JS_PUBLIC_KEY = "Z-BZ4xrKgJHY-BLJv";
